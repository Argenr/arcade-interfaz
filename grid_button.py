...
class GridButton(QPushButton):
    ...
    def __init__(self, game_data, row, col, parent_grid, parent=None):
        ...
        self.glow = self._create_glow_effect(self)
    ...
    def _create_glow_effect(self, parent_widget):
        glow = QGraphicsDropShadowEffect(parent_widget)
    ...
    def _show_overlay_safe(self):
        ...
        overlay_glow = self._create_glow_effect(self._overlay)
